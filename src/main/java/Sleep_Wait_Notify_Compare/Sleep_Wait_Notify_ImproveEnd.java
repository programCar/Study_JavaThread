...
public class Sleep_Wait_Notify_ImproveEnd {
    ...
    static final Object FIFTH_ROOM = new Object();
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            //大猫咪锁住FIFTH_ROOM，没有烤鸡腿不干活,进入waitset休息室等待,放开锁
            synchronized(FIFTH_ROOM){
                ...
                //大猫咪看看有没有烤鸡腿，没有就不干活，继续等待
                while (roasted_ChickenLeg != true ){

                    //大猫咪等待烤鸡腿送到FIFTH_ROOM
                    try {
                        FIFTH_ROOM.wait();
        ...
        new Thread(() -> {
            ...
            //二狗子锁住FIFTH_ROOM，没有烤鸭腿不干活，进入waitset休息室等待,放开锁
            synchronized(FIFTH_ROOM){
                ...
                //二狗子看看有没有烤鸭腿，没有就不干活
                while (roasted_DuckLeg != true ){

                    //二狗子等待烤鸭腿送到FIFTH_ROOM
                    try {
                        FIFTH_ROOM.wait();
                    } catch (InterruptedException e) {
                        e.printStackTrace();
