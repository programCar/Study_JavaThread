...
public class Sleep_Wait_Notify02 {
    ...
    static final Object THIRD_ROOM = new Object();
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            ...
            //大猫咪锁住THIRD_ROOM，没有烤鸡腿不干活，进入waitset休息室等待,放开锁
        ...
        new Thread(() -> {
            ...
            //二狗子锁住THIRD_ROOM，没有烤鸭腿不干活，进入waitset休息室等待,放开锁
            synchronized(THIRD_ROOM){
